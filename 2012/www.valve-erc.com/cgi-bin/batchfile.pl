...
<tr>
	...
	<tr>
	    ...
	    <td width="128" valign="top" background="/images/dark_blue.gif">
			...
			<a href="http://collective.valve-erc.com/"><b>Collective</b></a><br>
	...
	<FONT SIZE="5" COLOR="#CDCDCD"><B><I>Compile Batch File</I></B></FONT><BR>
	create a custom compile batch (version 1.1)</P>

		<p><img src="http://www.valve-erc.com/gfx/batch_compile_icon.gif" width="40" height="40" border="0" alt="" hspace="20" vspace="10" align="left"><strong>The Batch File</strong><br>
		The art of creating a batch file seems to be almost lost.  A batch file is a type of script file that automates the running of a batch of commands.  These commands are the same ones that you can enter through a <img src="http://www.valve-erc.com/gfx/command_prompt.gif" border="0" alt="" width="16" height="13"> Command Prompt.  The batch file was used extensively back in the days when Microsoft's current OS was DOS.  Now that people can click on something to make it run, they're used much less frequently.  They are still quite useful, however.  The process of compiling a map is a perfect example of where a batch file can be used to simplify things.  This script will walk you through a number of information gathering processes, then it will create batch file customized specifically for your system.</p>

		<p>This script assumes you are using Zoner's Half-Life compile tools.  If you're not, you should be.  <a href="/resources/?page=zhlt">They're available here</a>.  They're direct replacements for the old qcsg.exe, qbsp2.exe, vis.exe, and qrad.exe.  Many of the compile options made available to you through this script require ZHLT and will not work correctly with the old tools.</p>

		<form action="/cgi-bin/batchfile.pl" method="post"><input type="hidden" name="page" value="1"><input type="image" src="http://www.valve-erc.com/gfx/icons/arrow_right_001.gif" align="right" width="45" height="33"></form>
