...
<tr>
	...
	<FONT SIZE="6" COLOR="#CDCDCD"><B><I>Entities</I></B></FONT><BR>
	All entities, all the time.</P>

		<P><FONT SIZE="+2" COLOR="WHITE"><B>admin_v_erc.pl</B></FONT><BR>
		<FONT SIZE="-2" COLOR="GRAY"> entity</FONT></P>
	
			<P><B><FONT COLOR="WHITE">description</FONT></B><BR><UL>
			<I>no information</I></UL></P>
		<P><HR>
			<LI> <A HREF="/entities/?game=blue-shift&category=misc"><STRONG>back to  misc entity list</STRONG></A>
				
		<LI> <A HREF="/entities/?game=blue-shift">back to  entity list</A></P>
